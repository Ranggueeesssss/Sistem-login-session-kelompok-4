...
<body>
    ...
    <div class="main-content">
        <div class="header">
            <div class="breadcrumb">Panel / <strong>Profil Saya</strong></div>
            <div class="user-info">
        ...
        <div class="content-body">
            <div class="card">
                ...
                <table>
                    ...
                    <tr>
                        <td>Role</td>
                        <td><span class="badge" style="background: #27ae60; color: white; padding: 5px 12px; border-radius: 20px;">Guru</span></td>
                    </tr>
                    <tr>
                        <td>Status</td>
                        <td>Aktif</td>
