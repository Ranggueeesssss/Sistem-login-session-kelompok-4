...
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box;}
        body{background:linear-gradient(135deg,#1B263B,#415A77,#E0E1DD);font-family:'Poppins',sans-serif;min-height:100vh;}
        .layout{display:flex;}
        ...
        label{font-weight:600;color:#1B263B;}
        input[type="text"], input[type="password"], input[type="email"]{width:100%;padding:12px;border:1px solid #ced4da;border-radius:10px;}
        .btn{background:linear-gradient(90deg,#2D6A4F,#1B263B);color:#fff;border:none;padding:10px 16px;border-radius:10px;font-weight:700;cursor:pointer;box-shadow:0 6px 16px rgba(0,0,0,.2);}
    ...
    <div class="layout">
        ...
        <div class="main">
            ...
            <div class="card">
                ...
                <p style="font-size:13px;color:#55606a;margin-top:12px;">Catatan: fungsionalitas penyimpanan bisa ditambahkan pada backend sesuai kebutuhan.</p>
            </div>
        </div>
    </div>
</body>
